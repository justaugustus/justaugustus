...
- [bloomberg/oss-template](https://github.com/bloomberg/oss-template) - Open Source Project Template (6 days ago)
...
- [bloomberg/bloomberg.github.io](https://github.com/bloomberg/bloomberg.github.io) - Source code for the https://bloomberg.github.io site (4 weeks ago)
...
- [bloomberg/causal-ts](https://github.com/bloomberg/causal-ts) ([v0.25.2](https://github.com/bloomberg/causal-ts/releases/tag/v0.25.2), 2 days ago) - Causal Discovery for Time Series
- [darnitdevorg/darnit](https://github.com/darnitdevorg/darnit) ([v0.1.0](https://github.com/darnitdevorg/darnit/releases/tag/v0.1.0), 6 days ago) - 
...
- [spec: Proposal to wire Scorecard to `ExecutionContext`](https://github.com/darnitdevorg/darnit/pull/353) on [darnitdevorg/darnit](https://github.com/darnitdevorg/darnit) (4 days ago)
- [Org updates](https://github.com/uwu-tools/.github/pull/93) on [uwu-tools/.github](https://github.com/uwu-tools/.github) (6 days ago)
- [Add OpenSSF Baseline compliance docs (partial coverage)](https://github.com/bloomberg/oss-template/pull/38) on [bloomberg/oss-template](https://github.com/bloomberg/oss-template) (6 days ago)
...
- [carabiner-dev/miniprow](https://github.com/carabiner-dev/miniprow) - A GitHub app that emulates @kubernetes prow chatops on PRs but with enhaced security through AMPEL policies and secure tagging support (4 days ago)
...
- [andrew/weekend-at-bernies](https://github.com/andrew/weekend-at-bernies) - Data collection for Weekend at Bernie&#39;s blog post (6 days ago)
...
- [SAP/fork-metadata-standard](https://github.com/SAP/fork-metadata-standard) - The Fork Metadata Standard (FMS) defines a structured, platform-agnostic format for documenting the origin of a forked open-source project. (4 weeks ago)

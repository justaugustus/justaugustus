...
- [kubernetes-sigs/promo-tools](https://github.com/kubernetes-sigs/promo-tools) ([v4.3.0](https://github.com/kubernetes-sigs/promo-tools/releases/tag/v4.3.0), 6 days ago) - Container and file artifact promotion tooling for the Kubernetes project
...
- [:book: 2026 roadmap and OSPS Baseline conformance proposal](https://github.com/ossf/scorecard/pull/4952) on [ossf/scorecard](https://github.com/ossf/scorecard) (4 days ago)
...
- [carabiner-dev/policies](https://github.com/carabiner-dev/policies) - Policy sets for different frameworks (1 day ago)
- [NUKnightLab/sql-mysteries](https://github.com/NUKnightLab/sql-mysteries) - Inspired by @veltman&#39;s command-line mystery, use SQL to research clues and find out whodunit! (2 days ago)
- [veltman/clmystery](https://github.com/veltman/clmystery) - A command-line murder mystery (2 days ago)

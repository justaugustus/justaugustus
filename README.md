...
- [kubernetes-sigs/promo-tools](https://github.com/kubernetes-sigs/promo-tools) - Container and file artifact promotion tooling for the Kubernetes project (6 days ago)
...
- [ossf/scorecard-webapp](https://github.com/ossf/scorecard-webapp) ([v1.0.16](https://github.com/ossf/scorecard-webapp/releases/tag/v1.0.16), 1 week ago) - Website and API for OpenSSF Scorecard
...
- [Use `awesome-lint`, add Dependabot and CODEOWNERS configs](https://github.com/todogroup/awesome-ospo/pull/76) on [todogroup/awesome-ospo](https://github.com/todogroup/awesome-ospo) (today)
- [Release: promo-tools@v4.1.0](https://github.com/kubernetes-sigs/promo-tools/pull/1633) on [kubernetes-sigs/promo-tools](https://github.com/kubernetes-sigs/promo-tools) (6 days ago)
...
- [githubnext/awesome-continuous-ai](https://github.com/githubnext/awesome-continuous-ai) - An awesome list of Continuous AI Actions and Frameworks (today)
- [linuxfoundation/easycla](https://github.com/linuxfoundation/easycla) -  (today)
- [sethvargo/ratchet](https://github.com/sethvargo/ratchet) - A tool for securing CI/CD workflows with version pinning. (4 days ago)

...
- [bloomberg/pushiko](https://github.com/bloomberg/pushiko) ([1.0.7](https://github.com/bloomberg/pushiko/releases/tag/1.0.7), 3 days ago) - A JVM library for sending push notifications, currently via Apple Push Notification service (APNs) and Firebase Cloud Messaging (FCM).
...
- [Harden GitHub Action workflow security](https://github.com/ossf/allstar/pull/818) on [ossf/allstar](https://github.com/ossf/allstar) (today)
...
- [Bump stale codeql-action pins and add dependabot cooldown](https://github.com/uwu-tools/peribolos/pull/575) on [uwu-tools/peribolos](https://github.com/uwu-tools/peribolos) (2 days ago)
- [Harden GitHub Actions workflows and improve security policy](https://github.com/uwu-tools/peribolos/pull/574) on [uwu-tools/peribolos](https://github.com/uwu-tools/peribolos) (2 days ago)
- [dependabot: Configure grouped updates](https://github.com/uwu-tools/peribolos/pull/569) on [uwu-tools/peribolos](https://github.com/uwu-tools/peribolos) (2 days ago)
...
- [suzuki-shunsuke/pinact-action](https://github.com/suzuki-shunsuke/pinact-action) - GitHub Actions to pin GitHub Actions by pinact (4 days ago)
- [suzuki-shunsuke/pinact](https://github.com/suzuki-shunsuke/pinact) - pinact is a CLI to edit GitHub Workflow and Composite action files and pin versions of Actions and Reusable Workflows. pinact can also update their versions and verify version annotations. (4 days ago)

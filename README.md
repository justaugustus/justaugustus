...
- [bloomberg/pushiko](https://github.com/bloomberg/pushiko) ([1.0.7](https://github.com/bloomberg/pushiko/releases/tag/1.0.7), 2 days ago) - A JVM library for sending push notifications, currently via Apple Push Notification service (APNs) and Firebase Cloud Messaging (FCM).
...
- [kubernetes-sigs/release-sdk](https://github.com/kubernetes-sigs/release-sdk) ([v0.12.6](https://github.com/kubernetes-sigs/release-sdk/releases/tag/v0.12.6), 4 weeks ago) - Interfaces and implementations for building Kubernetes releases.
...
- [scorecard: restore comment, rename uploadSARIFResult, add error path tests](https://github.com/ossf/allstar/pull/816) on [ossf/allstar](https://github.com/ossf/allstar) (1 day ago)
- [go.mod: Migrate to sigs.k8s.io/prow, remove vendored third_party/](https://github.com/uwu-tools/peribolos/pull/576) on [uwu-tools/peribolos](https://github.com/uwu-tools/peribolos) (1 day ago)
- [Bump stale codeql-action pins and add dependabot cooldown](https://github.com/uwu-tools/peribolos/pull/575) on [uwu-tools/peribolos](https://github.com/uwu-tools/peribolos) (1 day ago)
- [Harden GitHub Actions workflows and improve security policy](https://github.com/uwu-tools/peribolos/pull/574) on [uwu-tools/peribolos](https://github.com/uwu-tools/peribolos) (1 day ago)
- [dependabot: Configure grouped updates](https://github.com/uwu-tools/peribolos/pull/569) on [uwu-tools/peribolos](https://github.com/uwu-tools/peribolos) (1 day ago)
...
- [scorecard: Add results file output for `scorecard-monitor` integration](https://github.com/ossf/allstar/pull/800) on [ossf/allstar](https://github.com/ossf/allstar) (2 weeks ago)

#### ⭐ Recent Stars

- [suzuki-shunsuke/pinact-action](https://github.com/suzuki-shunsuke/pinact-action) - GitHub Actions to pin GitHub Actions by pinact (3 days ago)
...
- [JulietSecurity/abom](https://github.com/JulietSecurity/abom) -  (1 week ago)

...
- [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) ([v1.32.1](https://github.com/kubernetes/kubernetes/releases/tag/v1.32.1), today) - Production-Grade Container Scheduling and Management
...
- [Simplify docs around Chair election, roles, and responsibilities](https://github.com/ossf/tac/pull/432) on [ossf/tac](https://github.com/ossf/tac) (6 days ago)
...
- [kubernetes-sigs/ingress2gateway](https://github.com/kubernetes-sigs/ingress2gateway) - Convert Ingress resources to Gateway API resources (6 days ago)

...
- [cisco-open/fsoc](https://github.com/cisco-open/fsoc) ([v0.50.0](https://github.com/cisco-open/fsoc/releases/tag/v0.50.0), today) - FSO Control CLI Utility
...
- [kubernetes-sigs/release-utils](https://github.com/kubernetes-sigs/release-utils) ([v0.7.5](https://github.com/kubernetes-sigs/release-utils/releases/tag/v0.7.5), 3 days ago) - 
- [ossf/scorecard-action](https://github.com/ossf/scorecard-action) ([v2.3.0](https://github.com/ossf/scorecard-action/releases/tag/v2.3.0), 6 days ago) - Official GitHub Action for OpenSSF Scorecard.
...
- [package-url/packageurl-go](https://github.com/package-url/packageurl-go) - Go implementation of the package url spec (4 weeks ago)

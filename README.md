...
- [ossf/scorecard-action](https://github.com/ossf/scorecard-action) ([v2.4.4](https://github.com/ossf/scorecard-action/releases/tag/v2.4.4), 3 days ago) - Official GitHub Action for OpenSSF Scorecard.
...
- [sashiko-dev/sashiko](https://github.com/sashiko-dev/sashiko) - Agentic review of Linux Kernel code changes (5 days ago)
- [darnitdevorg/darnit](https://github.com/darnitdevorg/darnit) -  (5 days ago)
- [oscarvalenzuelab/agentic-ai-github-actions](https://github.com/oscarvalenzuelab/agentic-ai-github-actions) - Agentic AI workflow for Supply Chain Analysis using GitHub Actions (5 days ago)

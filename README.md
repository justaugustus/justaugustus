...
- [uwu-tools/scorecard-mcp](https://github.com/uwu-tools/scorecard-mcp) -  (5 days ago)
...
- [bloomberg/causal-ts](https://github.com/bloomberg/causal-ts) ([v0.25.2](https://github.com/bloomberg/causal-ts/releases/tag/v0.25.2), 5 days ago) - Causal Discovery for Time Series
...
- [Bump harden-runner to v2.20.1 for Node 24 runtime](https://github.com/uwu-tools/.github/pull/98) on [uwu-tools/.github](https://github.com/uwu-tools/.github) (1 day ago)
- [Fix malformed org config and add pre-merge lint guard](https://github.com/uwu-tools/.github/pull/97) on [uwu-tools/.github](https://github.com/uwu-tools/.github) (1 day ago)
- [Match Ubuntu runner labels by pattern, not a fixed list](https://github.com/ossf/scorecard-webapp/pull/998) on [ossf/scorecard-webapp](https://github.com/ossf/scorecard-webapp) (2 days ago)
- [Research provider-agnostic Scorecard data infrastructure](https://github.com/uwu-tools/scorecard-infra/pull/19) on [uwu-tools/scorecard-infra](https://github.com/uwu-tools/scorecard-infra) (2 days ago)
- [Fix broken CI: lint config, private-repo perms, zizmor](https://github.com/uwu-tools/scorecard-infra/pull/12) on [uwu-tools/scorecard-infra](https://github.com/uwu-tools/scorecard-infra) (2 days ago)
- [Rename module path to scorecard-infra](https://github.com/uwu-tools/scorecard-infra/pull/11) on [uwu-tools/scorecard-infra](https://github.com/uwu-tools/scorecard-infra) (2 days ago)
- [Add fallback API server functionality](https://github.com/uwu-tools/scorecard-infra/pull/10) on [uwu-tools/scorecard-infra](https://github.com/uwu-tools/scorecard-infra) (3 days ago)
- [Archive v0 OpenSpec change and add feature flagging (OpenFeature)](https://github.com/uwu-tools/scorecard-infra/pull/9) on [uwu-tools/scorecard-infra](https://github.com/uwu-tools/scorecard-infra) (3 days ago)
- [feat: add local Docker Compose dev environment](https://github.com/uwu-tools/scorecard-infra/pull/8) on [uwu-tools/scorecard-infra](https://github.com/uwu-tools/scorecard-infra) (3 days ago)
- [Archive initial OpenSpec change and document MCP Inspector testing](https://github.com/uwu-tools/scorecard-mcp/pull/10) on [uwu-tools/scorecard-mcp](https://github.com/uwu-tools/scorecard-mcp) (5 days ago)

#### ⭐ Recent Stars

- [ossf/oss-crs-actions](https://github.com/ossf/oss-crs-actions) -  (1 day ago)
